...
mod test {
    ...
    fn test_correct_order() {
        ...
        let poly2 = Polynomial::new(vec![1.0, 2.0]);
        let poly3 = Polynomial::new(vec![1.0, 2.0, 3.0]);
    ...
    fn test_real_coefficients() {
        let poly1 = Polynomial::new(vec![1.0]);
        let poly2 = Polynomial::new(vec![1.0, 2.0]);
        let poly3 = Polynomial::new(vec![Complex64::new(1.0, 1.0)]);
        let poly4 = Polynomial::new(vec![Complex64::new(1.0, 1.0), Complex64::new(2.0, 2.0)]);
